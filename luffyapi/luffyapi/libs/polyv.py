...
class PolyvPlayer(object):
    def __init__(self,userId,secretkey,tokenUrl):
        """初始化，提供用户id和秘钥"""
        self.userId = userId  # 7617a871ce
        self.secretKey = secretkey  # uYLcgx2PR3
        self.tokenUrl = tokenUrl  # http://api.polyv.net/v2/play-list/create

    def tomd5(self, value):  # 生成sign请求参数的值
        """取md5值"""
