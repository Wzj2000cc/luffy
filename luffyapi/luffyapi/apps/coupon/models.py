...
class UserCoupon(BaseModel):
    ...
    coupon = models.ForeignKey(Coupon, on_delete=models.CASCADE, related_name="conupons", verbose_name="优惠券")
    start_time = models.DateTimeField(verbose_name="优惠策略的开始时间")
    # 这里没有结束时间，根据领取时间加上上一个表的有效期时间计算结束时间
    ...
    def end_time(self):
        ...
        return start_time + timedelta(days=use_time)